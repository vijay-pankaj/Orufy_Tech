 ...
 const handleLoginSubmit = async (e) => {
  ...
  try {
    ...
    const res = await axios.post(
      " https://orufy-tech-2.onrender.com/user/login",
      loginData
    );
...
const handleOtpSubmit = async (e) => {
  ...
  try {
    const res = await axios.post(
      'https://orufy-tech-2.onrender.com/user/verifyotp',
      { otp: otpData },
      {
        headers: {
  ...
  const handleSignupSubmit = async (e) => {
    ...
    e.preventDefault();
    try {
      const res = await axios.post(" https://orufy-tech-2.onrender.com/user/signup", signupData);
      toast.success(res.data.message);
      setSignupForm(false);
      setloginform(true);
      // setOtpForm(true);
  ...
  try {
    const res = await axios.post(
      ' https://orufy-tech-2.onrender.com/user/resendOtp',
      {},
      {
        headers: {
          Authorization: `Bearer ${token}`,
