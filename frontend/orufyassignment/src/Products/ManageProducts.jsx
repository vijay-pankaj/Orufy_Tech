...
const debounceSearch=useDebouncee(search)
  ...
  const removeImage = async (index) => {
    ...
    if (imageToRemove._id) {
      try {
        const res = await axios.delete(` https://orufy-tech-2.onrender.com/products/deleteimg/${imageToRemove._id}`,{headers:{Authorization:`Bearer ${Token}`}});
  ...
  const toggleProduct = async (id) => {
    try {
      const res = await axios.put(` https://orufy-tech-2.onrender.com/products/toggle/${id}`,{},{headers:{Authorization:`Bearer ${Token}`}})
      toast.success(res.data.message)
      fetchallProducts();
    } catch (error) {
      console.log(error);
  ...
  const fetchallProducts = async () => {
    try {
      const res = await axios.get(' https://orufy-tech-2.onrender.com/products/getallproduct',{headers:{Authorization:`Bearer ${Token}`}})
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        " https://orufy-tech-2.onrender.com/products/addproduct",
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(
        ` https://orufy-tech-2.onrender.com/products/editProduct/${editingProduct._id}`,
        formData,{headers:{Authorization:`Bearer ${Token}`}}
      );
  ...
  const deleteProduct = async (id) => {
    if (window.confirm("Are you sure you want to delete this product?")) {
      try {
        const res = await axios.delete(` https://orufy-tech-2.onrender.com/products/deleteproduct/${id}`,{headers:{Authorization:`Bearer ${Token}`}});
        toast.success(res.data.message);
        fetchallProducts();
      } catch (error) {
        console.log(error);
